        ...
        <section className="py-24 bg-[#080808]">
            <div className="container mx-auto px-4">
                <div className="flex items-center gap-4 mb-16">
                    <div className="w-3 h-16 bg-nitecore-yellow shadow-[0_0_20px_#ffe100]"></div>
                    <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter">{t['products.latest_release']}</h2>
                </div>
                    ...
                    {latestReleases.map((p, idx) => (
                        <div key={p.id} className={`flex flex-col lg:flex-row items-center gap-16 ${idx % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                            ...
                            <div className="flex-1 w-full relative group">
                                <div className="absolute inset-0 bg-nitecore-yellow/5 rounded-full blur-[100px] opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                                <img 
                            ...
                            <div className="flex-1 w-full space-y-8">
                                <div className="space-y-4">
                                    <h3 className="text-4xl md:text-6xl font-black text-white uppercase leading-none">{p.name}</h3>
                                    <div className="w-20 h-1 bg-nitecore-yellow"></div>
                                </div>
                                <p className="text-gray-400 text-lg md:text-xl leading-relaxed font-light text-justify">
                                    {p.description[lang]}
                                </p>
                                <div className="flex items-center gap-6 pt-4">
                                    <Link to={`/product/${p.id}`} className="group bg-transparent border-2 border-white text-white px-10 py-4 font-bold uppercase tracking-widest hover:bg-nitecore-yellow hover:border-nitecore-yellow hover:text-black transition-all rounded-sm flex items-center gap-3">
                ...
                <div className="mt-24 text-center">
                    <Link to="/shop" className="text-gray-500 hover:text-white uppercase font-bold tracking-widest text-sm border-b border-gray-700 hover:border-white pb-1 transition-all">{t['products.view_catalog']}</Link>
                </div>
            </div>
        </section>

        {/* 3. Award Winners Section - Full Width Banners */}
        <section className="py-24 bg-[#050505] border-t border-[#222]">
            <div className="container mx-auto px-4 mb-16">
                <div className="text-center">
                    <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-[0.2em] mb-4 flex items-center justify-center gap-4">
                        <Award className="text-nitecore-yellow" size={48} /> {t['awards.title']}
                    </h2>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 space-y-12">
                {awardWinners.map((p) => (
                    <div key={p.id} className="relative bg-[#111] rounded-3xl border border-[#222] overflow-hidden group hover:border-nitecore-yellow/30 transition-all duration-500">
                        ...
                        <div className="grid lg:grid-cols-2">
                            <div className="p-12 lg:p-20 flex flex-col justify-center relative z-10">
                                <h3 className="text-3xl md:text-5xl font-black text-white mb-6 leading-tight">{p.name}</h3>
                                <p className="text-gray-400 text-lg leading-relaxed mb-10">{p.description[lang]}</p>
                                <Link to={`/product/${p.id}`} className="self-start bg-white text-black px-10 py-4 font-bold uppercase rounded hover:bg-nitecore-yellow transition-colors shadow-lg">
                                    {t['common.view_details']}
                                </Link>
                            </div>
                            <div className="relative h-[400px] lg:h-auto bg-gradient-to-br from-[#1a1a1a] to-[#0d0d0d] flex items-center justify-center p-8">
                                <img src={p.images[0]} alt={p.name} className="max-w-full max-h-[90%] object-contain transition-transform duration-700 group-hover:scale-110 drop-shadow-2xl" />
                            </div>
                        </div>
                    </div>
                ))}
        ...
        <section className="py-24 bg-[#0a0a0a] border-t border-[#222]">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {topSales.map(p => (
                        <div key={p.id} className="group relative bg-[#151515] border border-[#222] hover:border-nitecore-yellow transition-all duration-300 rounded-2xl overflow-hidden flex flex-col">
                            <div className="aspect-square bg-[#1a1a1a] p-8 flex items-center justify-center relative overflow-hidden">
                                <div className="absolute inset-0 bg-nitecore-yellow/5 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            ...
                            <div className="p-8 flex-1 flex flex-col">
                                <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-nitecore-yellow transition-colors">{p.name}</h3>
                                <p className="text-gray-500 text-sm mb-6 line-clamp-3 leading-relaxed flex-1">{p.description[lang]}</p>
                                <div className="flex items-center justify-between pt-4 border-t border-[#333]">
                                    <span className="text-xl font-bold text-white">{formatPrice(p.price, t)}</span>
                                    <Link to={`/product/${p.id}`} className="text-nitecore-yellow text-sm font-bold uppercase tracking-wider hover:text-white transition-colors flex items-center gap-1">
            ...
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between mb-12">
                    <h2 className="text-3xl font-black text-white uppercase tracking-wider flex items-center gap-3">
                        <Calendar className="text-nitecore-yellow" /> {t['events.title']}
                    </h2>
                    <a href="https://flashlight.nitecore.com/About/events" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-white flex items-center gap-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <div key={idx} className="group cursor-pointer bg-[#111] rounded-xl border border-[#222] overflow-hidden hover:border-gray-600 transition-all flex flex-col h-full">
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                <h3 className="text-white font-bold text-sm mb-3 group-hover:text-nitecore-yellow transition-colors leading-snug">{t[event.title]}</h3>
                                <p className="text-gray-500 text-xs line-clamp-3 leading-relaxed mb-4 flex-1">{t[event.desc]}</p>
                                <span className="text-nitecore-yellow text-[10px] font-bold uppercase inline-block tracking-widest group-hover:underline mt-auto">Read More</span>
                            </div>
                        </div>
                    ))}
                </div>
      ...
      <div className="bg-[#101010] min-h-screen pb-20">
         ...
         <div className="container mx-auto px-4 mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
               {products.map(p => (
                  <div key={p.id} className="border border-olight-green/20 rounded-xl overflow-hidden bg-[#1a1a1a] hover:border-olight-green hover:shadow-[0_0_20px_rgba(0,255,0,0.2)] transition-all duration-300 group flex flex-col">
                      ...
                      <div className="relative bg-white aspect-square flex items-center justify-center p-4">
                          <img src={p.images[0]} alt={p.name} className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-110" />
                          {/* Hover Overlay */}
                      ...
                      <div className="p-4 flex flex-col flex-1">
                          <h3 className="text-white font-bold text-lg mb-1 group-hover:text-olight-green transition-colors">{p.name}</h3>
...
export const WubenPage: React.FC<PageProps> = ({ lang }) => {
   ...
   return (
      <div className="bg-white min-h-screen text-slate-900 font-sans overflow-x-hidden">
         ...
         {/* Feature Spotlight: Wuben X4 (Replaces Testimonials) */}
...
export const VictorinoxPage: React.FC<PageProps> = ({ lang }) => {
   ...
   return (
      <div className="bg-white min-h-screen text-slate-900 font-sans">
         ...
         <div className="bg-[#050505] text-white py-24 border-y border-gray-800 relative overflow-hidden">
